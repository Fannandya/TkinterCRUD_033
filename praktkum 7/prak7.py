...
def submit_nilai():
    ...
    messagebox.showinfo("hasil prediksi", f"prediksi fakultasL: {hasil_prediksi}")
...
def create_field(label_text):
    label = tk.Label(form_frame, text=label_text, fg="#FFFFFF", bg="#282a36", font=("Helvetica", 11))
    label.pack(pady=(5.0))
    entry = tk.Entry(form_frame, font=("Helvetica", 11),
                     bg="#44475a", fg="#FFFFFF", insertbackground="#FFFFFF", relief="flat", width=30)
    entry.pack(pady=3)
    return entry
